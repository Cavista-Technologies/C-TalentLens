...
import { createReferral } from './referralApi'
import { uploadReferralResume } from './resumeUpload'
import { getRequisitions } from '../requisitions/requisitionApi'
...
export function ReferralForm({ onCancel, onSaved }: ReferralFormProps) {
  ...
  return (
    <form className="form-panel referral-form" onSubmit={handleSubmit}>
      <label>
        Requisition
        <input
